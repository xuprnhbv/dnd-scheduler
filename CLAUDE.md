...
- **`waitForReady` default is 300s** (`src/whatsapp.js`). First-time QR auth needs a human-paced window, and reinit on a slow VPS can take ~2 min for chromium to come back up. Don't drop this below ~180s without a reason.
